package com.nrz.efj.chapter02.item13.treeset;

import com.nrz.efj.chapter02.item13.PhoneNumber;
...
//        numbers.add(6);
        ...
        Set<PhoneNumber> phoneNumbers = Collections.synchronizedSet(numbers);// 동기적으로 만들기
